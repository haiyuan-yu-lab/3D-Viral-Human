...
plot_df <- fread('/ix/djishnu/Priyamvada/viral-human-ppi/Github/3D-Viral-Human/Figure5/Data/Vir_Hu_Vir/Mutation_rate_comparison.txt.gz',
                     header = T)
output_dir <- '/ix/djishnu/Priyamvada/viral-human-ppi/Github/3D-Viral-Human/Figure5/Plots/Vir_Hu_Vir/'
colors <- c('#00429d','#ffffe0', '#93003a')
names(colors) <- c('>=1e-04:>=1e-04', '>=1e-04:<1e-04', '<1e-04:<1e-04')
...
bxp <- ggplot(
  ...
  scale_x_discrete(breaks=c('<1e-04:<1e-04', '>=1e-04:<1e-04', '>=1e-04:>=1e-04')) +
...
pdf(paste0(output_dir, '/', 'Mutation_rate_compare.pdf'), height = 3.9, width = 6)
print(bxp +  
        stat_pvalue_manual(
