...
library(rstatix)
library(dplyr)
plot_df <- fread('/ix/djishnu/Priyamvada/viral-human-ppi/Github/3D-Viral-Human/Figure5/Data/Vir_Hu_Hu/Mutation_rate_comparison.txt.gz', header = T)
...
bxp <- ggplot(
  ...
  geom_boxplot(width = 0.075, notch = TRUE, outliers = FALSE) +
