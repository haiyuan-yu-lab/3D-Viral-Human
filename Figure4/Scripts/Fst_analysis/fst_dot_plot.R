...
library(data.table)
library(xlsx)
neg_controls <- c('DOOLITTLE', 'SURFACE')
output_dir <- '~/Figure4/Data/Fst_analysis/Results' #directory where all Fst comparison results are stored 
plot_dir <- '~/Figure4/Plots/Fst_analysis'
