...
library(rstatix)
library(dplyr)
plot_df <- read.table('/ix/djishnu/Priyamvada/viral-human-ppi/Github/3D-Viral-Human/Figure_5/Data/Vir_Hu_Hu/HIV_HPV_comparison.txt', header = T)
...
pdf(paste0(output_dir, '/', 'HIV_HPV_comparison_publication.pdf'), height = 5, width = 6)
print(bxp + 
        stat_pvalue_manual(
